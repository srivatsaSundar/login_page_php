	...
	<center><h2>Sign Up</h2></center>
		...
		<!--	<div class="imgcontainer">
			...
			<div class="inner_container">
				...
				<div class="new">
				<button name="register" class="button-31" class="sign_up_btn" type="submit">Sign Up</button><br><br><br>
				
				<a href="index.php"><button  class="button-31" type="button" class="back_btn">Back to Login</button></a><br>
			</div>
		</form>
